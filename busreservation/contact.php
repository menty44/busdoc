...
<title>Welcome Bus booking application</title>
    ...
    <div id="content">
    	<div id="gallerycontainer">
			<div class="portfolio-area" style="margin:0 auto; padding:140px 20px 20px 20px; width:820px;">	
				<div id="contactleft">
					 BUS BOOKING SOFTWARE<br>
( FLORIDA TRANSPORT, INCORPORATED)<br>
NAIROBI KENYA<br>
Phone:  0720106420<br><br>

FLORIDA BUS<br>
(FLORIDA TRANSPORT, INCORPORATED)<br>
KISUMU,KENYA<br>
Florida Bus Co., NAIROBI<br>

Telephone No: 0720106420<br><br>


Contact Numbers:<br>
Florida Bus Company MOMBASA<br>
0720106420<br>
				</div><br>
				<div id="contactright">
					<h3>Message Form</h3>
